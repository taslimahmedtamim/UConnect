...
const opportunities = [
  {
    ...
    description: 'Work on cutting-edge ML projects in our Digital Services team',
    requirements: ['Strong Python skills', 'ML/DL experience', 'Good academics'],
  },
  {
    id: 2,
    company: 'bKash',
    logo: 'from-pink-500 to-rose-500',
    ...
    skillsGap: ['TypeScript', 'FinTech'],
    description: 'Build beautiful experiences for Bangladesh\'s leading mobile financial service',
  ...
  },
  {
    ...
    description: 'Join our ride-sharing and delivery platform team',
  ...
  },
  {
    ...
    skillsGap: ['AWS', 'Spark'],
    description: 'Work on customer analytics and recommendation systems',
    requirements: ['ML fundamentals', 'Strong coding', 'Data structures'],
  },
  {
    id: 5,
    company: 'Chaldal',
    logo: 'from-green-500 to-teal-500',
    ...
    description: 'Scale our online grocery platform to millions of users',
  ...
  },
  {
    ...
    skillsGap: ['B2B Commerce'],
    description: 'Build features for Bangladesh\'s leading B2B commerce platform',
    requirements: ['Full-stack skills', 'Fast learner', 'E-commerce interest'],
  },
];
