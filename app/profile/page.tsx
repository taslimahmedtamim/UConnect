                    ...
                    <div key={i} className="inline-flex items-center gap-2 bg-[#1e293b] border border-[#334155] px-3 py-1.5 rounded-full group hover:border-slate-500 transition-colors shrink-0">
                      ...
                      {isGitHub && (
                        <div className="flex items-center gap-1 bg-emerald-500/10 px-1.5 py-0.5 rounded-full border border-emerald-500/20">
                          <ShieldCheck className="w-3 h-3 text-emerald-500" title="Verified by GitHub" />
                          <svg className="w-3.5 h-3.5 text-slate-300" fill="currentColor" viewBox="0 0 24 24" title="Synced from GitHub">
